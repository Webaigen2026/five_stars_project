...
export default function HeroSection() {
  return (
    <section className="relative overflow-hidden  text-white h-[130vh]">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-20 sm:py-24 lg:py-28">
        <div className="max-w-3xl">
          ...
          <h1 className="mt-5 text-4xl text-black font-semibold tracking-tight sm:text-5xl lg:text-6xl">
