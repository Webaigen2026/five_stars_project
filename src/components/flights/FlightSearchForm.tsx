    ...
    >
      ...
      */}
      <div className="mb-7 flex w-full min-w-0 flex-col gap-5 border-b border-slate-100 pb-5 lg:flex-row lg:items-end lg:justify-between lg:gap-6">
        ...
        />
        <h2 className="hidden md:block w-full min-w-0 text-balance text-[26px] font-medium leading-[1.2] tracking-[-0.025em] text-slate-950 lg:mt-0 lg:flex-1 lg:text-right">
