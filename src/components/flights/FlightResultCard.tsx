  ...
  return (
    <article className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
      <div className="grid gap-5 lg:grid-cols-[1fr_auto] lg:items-center">
        ...
        <div className="border-t border-slate-200 pt-4 lg:min-w-48 lg:border-l lg:border-t-0 lg:pl-6 lg:pt-0">
          <p className="text-sm text-slate-500">From</p>

          <p className="fs-nums mt-1 text-3xl font-bold tracking-tight text-slate-950">
          ...
          <button
            type="button"
            onClick={onSelect}
            className="mt-4 inline-flex w-full justify-center rounded-xl bg-primary px-5 py-3 text-sm font-semibold text-white transition hover:bg-primary-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/30"
          >
            {selectLabel}
          </button>
        </div>
